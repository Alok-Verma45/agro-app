...
function ProductDetail() {
  ...
  const getStockStatus = () => {
    ...
    if (product.quantity <= 5) {
      return {
        text: `Low Stock (केवल ${product.quantity} बचा है)`,
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 py-6">
      ...
      <button
        ...
        text-sm text-gray-400 hover:text-green-400 
        transition group"
      >
        ...
        p-6 rounded-2xl shadow-xl">
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl font-semibold transition ${
              product.quantity > 0
                ? "bg-green-500 hover:bg-green-600 text-white shadow-md hover:shadow-green-500/30"
